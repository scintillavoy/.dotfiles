...
alias glt='TZ=UTC0 git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)% D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph'
alias glta='TZ=UTC0 git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)% D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --all'
alias gltA='TZ=UTC0 git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)% D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph $(git rev-list -g --all)'
alias gltr='TZ=UTC0 git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)% D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --reverse'
