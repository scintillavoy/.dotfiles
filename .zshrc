...
alias gl='git log --date=format:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --graph'
alias gla='git log --date=format:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --graph --all'
alias glA='git log --date=format:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --graph $(git rev-list -g --all)'
alias glr='git log --date=format:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --reverse'
alias glt='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --graph'
alias glta='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --graph --all'
alias gltA='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --graph $(git rev-list -g --all)'
alias gltr='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%>|(24)%h %Cgreen%cd %C(auto)%<(70,trunc)%s %C(bold blue)%<(20,trunc)%an %C(auto)%D" --reverse'
alias glg='git log --date=format:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --graph'
alias glga='git log --date=format:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --graph --all'
alias glgA='git log --date=format:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --graph $(git rev-list -g --all)'
alias glgr='git log --date=format:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --reverse'
alias glgt='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --graph'
alias glgta='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --graph --all'
alias glgtA='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --graph $(git rev-list -g --all)'
alias glgtr='TZ=UTC0 git log --date=format-local:"%F %T" --format="%C(auto)%h %Cgreen%cd %C(auto)%s %C(bold blue)%an %C(auto)%D" --reverse'
