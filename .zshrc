...
alias glf='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --first-parent'
...
alias glu='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph @{upstream}'
...
alias gltf='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --first-parent'
...
alias gltu='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)),trunc)%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph @{upstream}'
