...
alias glav='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph --all'
alias glAv='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph $(git rev-list -g --all)'
...
alias glrv='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+8))%.*},${$((COLUMNS/3.4+8))%.*})%C(auto)%b" --reverse'
alias gluv='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph @{upstream}'
...
alias glat='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --all'
alias glAt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph $(git rev-list -g --all)'
...
alias glrt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --reverse'
alias glut='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph @{upstream}'
alias glvt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph'
alias glatv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph --all'
alias glAtv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph $(git rev-list -g --all)'
...
alias glrtv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+8))%.*},${$((COLUMNS/3.4+8))%.*})%C(auto)%b" --reverse'
alias glutv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an%n%w(0,${$((COLUMNS/3.4+6))%.*},${$((COLUMNS/3.4+6))%.*})%C(auto)%b" --graph @{upstream}'
...
alias glgav='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph --all'
alias glgAv='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph $(git rev-list -g --all)'
...
alias glgrv='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --reverse'
alias glguv='git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph @{upstream}'

alias glgt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph'
alias glgat='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph --all'
alias glgAt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph $(git rev-list -g --all)'
alias glgft='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph --first-parent'
alias glgrt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --reverse'
alias glgut='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph @{upstream}'
alias glgvt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph'
alias glgatv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph --all'
alias glgAtv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph $(git rev-list -g --all)'
...
alias glgrtv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --reverse'
alias glgutv='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an%n%w(0,2,2)%C(auto)%b" --graph @{upstream}'
