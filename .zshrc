...
alias gbat='git branch --all --sort=-committerdate'
alias gbrt='git branch --remotes --sort=-committerdate'
alias gbnmt='git branch --no-merged --sort=-committerdate'
alias gbanmt='git branch --all --no-merged --sort=-committerdate'
alias gbrnmt='git branch --remotes --no-merged --sort=-committerdate'
alias gbvt='git branch -vv --sort=-committerdate'
alias gbvat='git branch -vv --all --sort=-committerdate'
alias gbvrt='git branch -vv --remotes --sort=-committerdate'
alias gbvnmt='git branch -vv --no-merged --sort=-committerdate'
alias gbvanmt='git branch -vv --all --no-merged --sort=-committerdate'
alias gbvrnmt='git branch -vv --remotes --no-merged --sort=-committerdate'
