...
alias gl='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph'
alias gla='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --all'
alias glA='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph $(git rev-list -g --all)'
alias glf='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --first-parent'
alias glr='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --reverse'
alias glu='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph @{upstream}'
...
alias gltf='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%<|($((COLUMNS/3.4+5)))%D %<|($((COLUMNS/1.15-23)),trunc)%s %Cgreen%cd %C(auto)%h %C(bold blue)%<|(-1,trunc)%an" --graph --first-parent'
...
alias glg='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph'
alias glga='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph --all'
alias glgA='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph $(git rev-list -g --all)'
alias glgf='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph --first-parent'
alias glgr='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --reverse'
alias glgu='git log --date=format:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph @{upstream}'
...
alias glgtf='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph --first-parent'
alias glgtr='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --reverse'
alias glgt='TZ=UTC0 git log --date=format-local:"%y-%m-%d %H:%M" --format="%C(auto)%h%d %s %Cgreen%cd %C(bold blue)%an" --graph @{upstream}'
